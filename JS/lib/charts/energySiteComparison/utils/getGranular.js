import { timeFormat, timeHour } from 'd3';
export const getGranular = (x) => {
    ...
    const returnValue = Object.assign({ isGranular: da.latestDay - da.earlyDay <= 14, diff: da.latestDay - da.earlyDay }, da);
    return returnValue;
};
...
//# sourceMappingURL=getGranular.js.map